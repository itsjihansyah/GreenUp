...
public class UpdatePlantFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private UpdatePlantFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private UpdatePlantFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static UpdatePlantFragmentArgs fromBundle(@NonNull Bundle bundle) {
    UpdatePlantFragmentArgs __result = new UpdatePlantFragmentArgs();
    bundle.setClassLoader(UpdatePlantFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static UpdatePlantFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    UpdatePlantFragmentArgs that = (UpdatePlantFragmentArgs) object;
  ...
  public String toString() {
    return "UpdatePlantFragmentArgs{"
        + "id=" + getId()
        + ", name=" + getName()
        + ", type=" + getType()
        + "}";
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull UpdatePlantFragmentArgs original) {
    ...
    @NonNull
    public UpdatePlantFragmentArgs build() {
      UpdatePlantFragmentArgs result = new UpdatePlantFragmentArgs(arguments);
      return result;
    }
